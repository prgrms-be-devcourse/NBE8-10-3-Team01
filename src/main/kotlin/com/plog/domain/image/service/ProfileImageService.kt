...
interface ProfileImageService {
    ...
    /** 회원의 프로필 이미지를 업로드합니다. 기존 프로필 이미지가 있는 경우 교체됩니다. */
    fun uploadProfileImage(memberId: Long, file: MultipartFile): ProfileImageUploadRes

    /** 회원의 프로필 이미지를 조회합니다. */
    fun getProfileImage(memberId: Long): ProfileImageUploadRes
